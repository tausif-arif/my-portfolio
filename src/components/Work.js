...
const Work = () => {
  ...
  return (
    <div className="main_work">
      ...
      <WorkCard title="Weather 1.0" desc="a weather app" img={weatherimg} url={link.clicks}/>
      <WorkCard title="Clicks" desc="an unsplash clone" img={clicksimg} url={link.weather}/>
